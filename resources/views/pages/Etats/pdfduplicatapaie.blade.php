...
<body onload="window.print();">
    <div class="invoice">
        ...
        <section>
            ...
            <div class="info">
                ...
                <p>Date : {{ $facturePaie->datepaiementcontrat }} </p>
    ...
    <section>
        ...
        <p class="textmontant">Arrêtée, la présente facture à la somme de <span class="prix"> {{ $facturePaie->montant_total }}</span> FCFA.</p>
        <br>
        <div class="table2">
            <div class="infomecef">
                <div class="qcode">
