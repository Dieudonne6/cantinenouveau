                            ...
                            <form action="{{ url('/traitementetatpaiement') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input name="debut" id="debut" type="date" value="{{ old('date', now()->subMonths(3)->format('Y-m-d')) }}" class="typeaheads" required>
                                    </div>
                                    <div class="col">
                                        <label for="fin">Au</label>
                                        <input name="fin" id="fin" type="date" value="{{ old('date', now()->format('Y-m-d')) }}" class="typeaheads" required>
                                    </div>
